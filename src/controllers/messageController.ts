...
// @access  Private
export const getMyMessages = asyncHandler(async (req: AuthRequest, res: Response) => {
  if (!req.user) {
    res.status(401);
...
// @access  Private/Admin
export const respondToMessage = asyncHandler(async (req: AuthRequest, res: Response) => {
...
// @access  Private/Admin
export const getUnhandledCount = asyncHandler(async (req: AuthRequest, res: Response) => {
...
// @access  Private
export const getUnreadMessages = asyncHandler(async (req: AuthRequest, res: Response) => {
  if (!req.user) {
    res.status(401);
    throw new Error('Not authorized');
  }
